...
from views.microsentry.canvas import SegPathItem, CanvasPair
...
class TestImageLabelInteraction:
    ...
    def test_draw_and_finish_polygon(self, qtbot, active_canvas):
        ...
        assert len(active_canvas.current_polygon_points) == 3, "Canvas should have 3 pending points."
        ...
        assert len(active_canvas.current_polygon_points) == 0, "Pending points should clear after finishing."
    ...
    def test_zoom_in_and_out(self, qtbot, active_canvas):
        ...
        # Assert
        assert active_canvas._zoom == pytest.approx(initial_zoom), "Zoom factor should return to base."
...
class TestSegPathItemGeometry:
    ...
    def test_douglas_peucker_simplification(self):
        ...
        assert len(simplified_pts) == 4, "The intermediate near-collinear point should be removed."
